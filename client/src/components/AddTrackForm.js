...
function AddTrackForm({onAddTrack, releaseId, onChangeIsFormVis}){
    ...
    return (
        ...
        <form className="ui inverted form tiny" style={{width: "350px"}} onSubmit={formik.handleSubmit}>  
            ...
            <button onClick={onChangeIsFormVis} className="ui button inverted grey tiny" type="button">Hide Form</button>
            <button style={{float: "right"}} className="ui button inverted grey tiny" type="submit">Submit</button>
        </form>
